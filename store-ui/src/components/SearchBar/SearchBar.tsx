 ...
 * TODO
 * X Update logo
 * X Add dark theme toggle 
 * - Update profile selection (DISABLE if possible until developed)
 * - Add login and sign in button to the left
 * - refactor this to improve modularity
 */
